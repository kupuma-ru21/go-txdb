...
var LinkWhere = struct {
	...
	UserID:  whereHelpernull_Int{field: "`Links`.`UserID`"},
}
...
var (
	...
	linkColumnsWithoutDefault = []string{"Title", "Address", "UserID"}
...
func (o *Link) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to populate default values for Links")
	}
...
func (o *Link) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to upsert for Links")
	}
	...
	if err != nil {
		return errors.Wrap(err, "db: unable to retrieve unique values for Links")
	}
